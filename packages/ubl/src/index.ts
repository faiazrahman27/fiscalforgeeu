...
const UBL_EXPORT_NOTE =
  "Generated by Invoice Lantern as an independent technical UBL 2.1 export. Not official validation, not Peppol-certified, not legal/tax/accounting advice, not official filing, and not authority acceptance.";
...
export function canonicalToUblInvoiceXml(invoice: CanonicalInvoice): string {
  ...
  appendTextElement(root, "cbc:Note", UBL_EXPORT_NOTE);
